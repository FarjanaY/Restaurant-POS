// Small hand-rolled icon set (no icon library dependency) — plain stroke-based
// SVGs in the style of the sidebar/top-bar nav; category icons use emoji instead.
...
export function IconChefHat(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M6 18.5V11a4 4 0 0 1 3-3.87 3.5 3.5 0 0 1 6.9-1.13A4 4 0 0 1 19 10v8.5" />
      <path d="M5 18.5h14a1 1 0 0 1 1 1V21H4v-1.5a1 1 0 0 1 1-1z" />
    </svg>
  );
}
...
export function IconUserCheck(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <polyline points="17 13.5 18.5 15 21.5 12" />
    </svg>
  );
}
...
export function IconHelpCircle(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <circle cx="12" cy="12" r="9" />
      <path d="M9.5 9a2.5 2.5 0 0 1 4.6-1.35c.5.8.3 1.9-.5 2.5l-.6.45a2 2 0 0 0-.85 1.6V13" />
